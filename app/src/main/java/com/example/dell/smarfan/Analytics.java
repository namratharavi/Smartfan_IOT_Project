...
public class Analytics extends AppCompatActivity implements
        OnChartGestureListener,
        OnChartValueSelectedListener {

    SQLiteDatabase db;
    ArrayList <String> time;
    ArrayList <Entry> temps;
    GraphView graph;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChart.setDescription("time - temperature variations");
    ...
    private ArrayList<Entry> setYAxisValues() {
        ...
        {
            do{
                temps.add(new Entry(Float.valueOf(c.getString(1)),i));
                i++;
            }while(c.moveToNext());
        }
        c.close();
    ...
    private ArrayList<String> setXAxisValues() {
        ...
        db = openOrCreateDatabase("AlarmDB", Context.MODE_PRIVATE, null);
        Cursor c=db.rawQuery("SELECT * FROM details ", null);
        if(c.moveToFirst())
        {
            do{
